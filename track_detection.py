...
# Define a function to display frames
def display_frames(frame_copy):
    while True:  
...
process_thread = threading.Thread(target=process_frames, args=(frames,))
process_thread.start()

# Create a thread for displaying frames
display_thread = threading.Thread(target=display_frames, args=(frames,))
